...
div_yorker_ad = dist_ad * (2/20.12)
div_full_ad = dist_ad * (6/20.12)
div_good_ad = dist_ad * (7/20.12)
div_back_ad = dist_ad * (8/20.12)


div_yorker_bc = dist_bc * (2/20.12)
div_full_bc = dist_bc * (6/20.12)
div_good_bc = dist_bc * (7/20.12)
div_back_bc = dist_bc * (8/20.12)
...
cv2.line(final_frame, (340,383), (534,422), (255, 0, 0), 2)
cv2.line(final_frame, (294,388), (581,417), (255, 0, 0), 2)
